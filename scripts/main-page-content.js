...
const kinveyAppID = 'kid_SJ3jlwpxm';
const kinveyAppSecret = '3b717381355a4d50acbd4680923f901c';
...
function showAJAXError (data, status) {
    let errorMsg = 'Error: ' + JSON.stringify(data) + " <br/> " +
        "Read this to know what's happening: Try another username,please.";
    showError(errorMsg);
}
function showBooksAjaxError(data, status) {
    let errorMsg = 'Error: ' + JSON.stringify(data);
    // or
    let errorMsgBk = "Login first!!!";
...
function register() {
    ...
    function registerSuccess(data, status) {
        ...
        showInfo('Your Registration is complete.');
    }
}
